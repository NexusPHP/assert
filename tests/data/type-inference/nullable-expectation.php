...
{
    $assert = Assert::that($value)->nullOr()->implementsInterface(\Countable::class);
    assertType('Nexus\\Assert\\NullableExpectation<class-string<Countable>|null>', $assert);
    assertType('class-string<Countable>|null', $value);
}
...
function test_is_instance_of_any(mixed $value): void
{
    ...
    assertType('Nexus\\Assert\\NullableExpectation<Countable|DateTimeInterface|null>', $assert);
    assertType('Countable|DateTimeInterface|null', $value);
}
...
{
    $assert = Assert::that($value)->nullOr()->isIntOrNonEmptyString();
    assertType('Nexus\\Assert\\NullableExpectation<int|non-empty-string|null>', $assert);
    assertType('int|non-empty-string|null', $value);
}
...
{
    $assert = Assert::that($value)->nullOr()->isNonEmptyList();
    assertType('Nexus\\Assert\\NullableExpectation<non-empty-list<mixed>|null>', $assert);
    assertType('non-empty-list<mixed>|null', $value);
}

function test_is_non_empty_map(mixed $value): void
{
    $assert = Assert::that($value)->nullOr()->isNonEmptyMap();
    assertType('Nexus\\Assert\\NullableExpectation<non-empty-array<string, mixed>|null>', $assert);
    assertType('non-empty-array<string, mixed>|null', $value);
}
...
{
    $assert = Assert::that($value)->nullOr()->isNumericString();
    assertType('Nexus\\Assert\\NullableExpectation<numeric-string|null>', $assert);
    assertType('numeric-string|null', $value);
}
...
{
    $assert = Assert::that($value)->nullOr()->isOneOf(['light', 'dark']);
    assertType('Nexus\\Assert\\NullableExpectation<\'dark\'|\'light\'|null>', $assert);
    assertType('\'dark\'|\'light\'|null', $value);
}
