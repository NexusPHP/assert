...
{
    $assert = Assert::that($value)->isArrayAccessible();
    assertType('Nexus\\Assert\\Expectation<array<mixed, mixed>|ArrayAccess>', $assert);
    assertType('array<mixed, mixed>|ArrayAccess', $value);
}
