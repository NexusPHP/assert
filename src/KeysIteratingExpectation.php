...
final readonly class KeysIteratingExpectation implements Expectable
{
    ...
    private const MESSAGE_IS_GREATER_THAN = 'Key "{value}" in iterable is expected to be a number greater than {limit}.';
    private const MESSAGE_IS_GREATER_THAN_OR_EQUAL = 'Key "{value}" in iterable is expected to be a number greater than or equal to {limit}.';
    ...
    private const MESSAGE_IS_LESS_THAN = 'Key "{value}" in iterable is expected to be a number less than {limit}.';
    private const MESSAGE_IS_LESS_THAN_OR_EQUAL = 'Key "{value}" in iterable is expected to be a number less than or equal to {limit}.';
    ...
    private const MESSAGE_IS_NON_EMPTY_MAP = 'Key "{value}" in iterable is expected to be a non-empty map but got {type} instead.';
    ...
    private const MESSAGE_IS_SAME_OR_SUBCLASS_OF = 'Key "{value}" in iterable is expected to be {class} or a subclass of it but got {type} instead.';
    ...
    private const MESSAGE_IS_SUBCLASS_OF = 'Key "{value}" in iterable is expected to be a subclass of {class} but got {type} instead.';
    ...
    public function implementsInterface(string $interface, ?string $message = null): self
    {
        foreach ($this->value as $offsetKey => $_) {
            try {
                Assert::that($offsetKey)->implementsInterface($interface, $message);
            } catch (ExpectationFailedException) {
                throw new ExpectationFailedException(
    ...
    public function isGreaterThan(float|int $limit, ?string $message = null): self
    {
        foreach ($this->value as $offsetKey => $_) {
            try {
                Assert::that($offsetKey)->isGreaterThan($limit, $message);
            } catch (ExpectationFailedException) {
                throw new ExpectationFailedException(
    ...
    public function isGreaterThanOrEqual(float|int $limit, ?string $message = null): self
    {
        foreach ($this->value as $offsetKey => $_) {
            try {
                Assert::that($offsetKey)->isGreaterThanOrEqual($limit, $message);
            } catch (ExpectationFailedException) {
                throw new ExpectationFailedException(
    ...
    public function isLessThan(float|int $limit, ?string $message = null): self
    {
        foreach ($this->value as $offsetKey => $_) {
            try {
                Assert::that($offsetKey)->isLessThan($limit, $message);
            } catch (ExpectationFailedException) {
                throw new ExpectationFailedException(
    ...
    public function isLessThanOrEqual(float|int $limit, ?string $message = null): self
    {
        foreach ($this->value as $offsetKey => $_) {
            try {
                Assert::that($offsetKey)->isLessThanOrEqual($limit, $message);
            } catch (ExpectationFailedException) {
                throw new ExpectationFailedException(
    ...
    {
        if ($this->isArray) {
            throw new \LogicException('Method isNonEmptyMap() cannot be called on keys of an array; array keys are constrained to int|string.');
        }

        foreach ($this->value as $offsetKey => $_) {
            try {
                Assert::that($offsetKey)->isNonEmptyMap($message);
            } catch (ExpectationFailedException) {
                throw new ExpectationFailedException(
    ...
    public function isOneOf(array $choices, ?string $message = null): self
    {
        foreach ($this->value as $offsetKey => $_) {
            try {
                Assert::that($offsetKey)->isOneOf($choices, $message);
            } catch (ExpectationFailedException) {
                throw new ExpectationFailedException(
    ...
    public function isSameOrSubclassOf(object|string $class, ?string $message = null): self
    {
        foreach ($this->value as $offsetKey => $_) {
            try {
                Assert::that($offsetKey)->isSameOrSubclassOf($class, $message);
            } catch (ExpectationFailedException) {
                throw new ExpectationFailedException(
    ...
    public function isSubclassOf(object|string $class, ?string $message = null): self
    {
        foreach ($this->value as $offsetKey => $_) {
            try {
                Assert::that($offsetKey)->isSubclassOf($class, $message);
            } catch (ExpectationFailedException) {
                throw new ExpectationFailedException(
