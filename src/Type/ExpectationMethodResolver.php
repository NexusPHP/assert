...
final class ExpectationMethodResolver
{
    ...
    private static function createExprResolvers(ReflectionProvider $reflectionProvider): array
    {
        ...
        return [
            ...
            'isLessThan' => new Resolver\NumberComparisonResolver(Node\Expr\BinaryOp\Smaller::class, $isInt, $isFloat),
            'isLessThanOrEqual' => new Resolver\NumberComparisonResolver(Node\Expr\BinaryOp\SmallerOrEqual::class, $isInt, $isFloat),
            'isList' => $isList,
            ...
            'isNumericString' => new Resolver\IsNumericStringResolver($isString),
            'isObject' => $isObject,
